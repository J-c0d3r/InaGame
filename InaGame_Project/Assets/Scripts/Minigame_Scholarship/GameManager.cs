...
namespace Scholarship
{
    public class GameManager : MonoBehaviour
    {
        ...
        public void StartGame()
        {
            ...
            gameRunning = true;
            enemy.GetComponent<Enemy>().SetSpeed(ArraySpeedEnemy[0]);
            AudioManager.audioManager.PlayOneShot(audioButton, 1);
            AudioManager.audioManager.PlaySong(songPhase, true);
        }
        ...
        public void VictoryGame()
        {
            ...
            if (enemy.GetComponent<Enemy>() != null)
                enemy.GetComponent<Enemy>().SetSpeed(0);
            ...
            global::GameManager.instance.SetXPPlayer(xp); //This is the GameManager from Menu Missions scene
            ...
            else
            {
                ...
                AudioManager.audioManager.PlaySong(songGameOver, false);
            }
        ...
        {
            currentSpawnPoint++;
            enemy.GetComponent<Enemy>().SetSpeed(ArraySpeedEnemy[currentSpawnPoint]);
            ...
            if (spawnName == "Spawn2_PUp")
            {
                ...
                AudioManager.audioManager.PlayOneShot(audioPowerUpDoubleJump, 1);
            }
        }
        ...
        public void RespawnByDeath()
        {
            ...
            AudioManager.audioManager.PlayOneShot(player.audioHit, 1);
